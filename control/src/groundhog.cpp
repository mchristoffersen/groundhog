...
// Queue for passing data from radio download thread to triggering/stacking
// thread
...
size_t detect_prf(std::complex<short>* buff, size_t buff_len, short trigger,
...
int UHD_SAFE_MAIN(int argc, char* argv[]) {
  ...
  size_t prf_meas =
      detect_prf(prf_buff, prf_stream_cmd.num_samps, trigger, spt, rate);
  if (prf_meas == 0) {
