...
def worker(q, usrp, stack, trig, trace_len, fs, pre_trig=32):
    ...
    with h5py.File(fn, "x") as fd:
        ...
        while True:
            ...
            if(blocks_since_trig > 20):
                print("Special Martin trigger halving :P")
                trig *= .5
                blocks_since_trig = 0
            ...
            while trig_loc != 0 or crnt_trig[0]:
                ...
                # Blank out trigger detection over duration of trace in crnt (and next if applicable)
                ...
                if(bufsize+trig_loc+trace_len-pre_trig > 2*bufsize):
                    next[:(bufsize+trig_loc+trace_len-pre_trig)-2*bufsize] = 0
                num_stacks += 1
                ...
                if num_stacks == stack:
                    ...
                    num_trace += 1 
                    sys.stdout.write("Num trace = %d    \r" % num_trace)
                    sys.stdout.flush()                          
